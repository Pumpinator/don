...
public class DataComponent {
    ...
    public void createData(ApplicationReadyEvent event) {
        ...
        RawMaterialInventory flourInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(flour).quantity(10).measure(kilogram).cost(160).supplier(proveedorHarinas).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory sugarInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(sugar).quantity(10).measure(kilogram).cost(360).supplier(proveedorDulces).build());
        RawMaterialInventory butterInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(butter).quantity(10).measure(kilogram).cost(2400).supplier(proveedorLacteos).expirationDate(LocalDate.now().plusMonths(6)).build());
        ...
        RawMaterialInventory bakingPowderInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(bakingPowder).quantity(10).measure(kilogram).cost(2000).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory vanillaInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(vanilla).quantity(1).measure(kilogram).cost(1000).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory saltInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(salt).quantity(10).measure(kilogram).cost(600).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory oatInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(oat).quantity(10).measure(kilogram).cost(650).supplier(proveedorHarinas).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory raisinsInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(raisins).quantity(10).measure(kilogram).cost(650).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory nutsInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(nuts).quantity(10).measure(kilogram).cost(6000).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory chocolateChipsInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(chocolateChips).quantity(10).measure(kilogram).cost(650).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
        RawMaterialInventory coloredChipsInventory = createRawMaterialInventory(RawMaterialInventory.builder().rawMaterial(coloredChips).quantity(10).measure(kilogram).cost(650).supplier(proveedorDulces).expirationDate(LocalDate.now().plusMonths(6)).build());
